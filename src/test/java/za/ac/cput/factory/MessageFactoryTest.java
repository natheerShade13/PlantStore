...
class MessageFactoryTest {
    ...
    void buildMessage() {
        ...
        messageA = MessageFactory.buildMessage("123", "Test Subject A", "Test Message A", false, dateSentA, customerA, employeeA);
        assertNotNull(messageA);
        assertEquals("123", messageA.getMessageId());
    ...
    void testBuildMessage() {
        ...
        assertTrue(messageB.getMessageId().isEmpty());
